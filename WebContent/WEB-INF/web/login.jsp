...
<body>
	<div class="wrapper">
		<form id="frm" name="frm" method="POST" action="<%=path%>/postLoginAction"
			class="login">
		...
		function checkName(userName) {
			...
			$.ajax({
				...
				success : function(data) {
					res = data.status;
					if (res == 0) {
						$('.username_tip').html("<span class='iconfont icon-brush password_p' style='color:#666;font-size:18px;'></span>...该用户不存在");
						return false;
					} else {
						$('.username_tip').html("");
						return true;
