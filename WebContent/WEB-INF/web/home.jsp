        ...
        <div class="anchor_layer" id="navHeight">
            <div class="nav_wrap" id="nav_wrap">
                <div class="wrap_layer">
                    ...
                    <div class="wrap_tab last_wrap_tab"><a class="tab" href="myself.jsp">个人中心</a></div>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="forum-wrap">
                    <div class="forum-box">
                        ...
                        <div class="forum-funs icon-left">
                            <span class="forum-icon"><img src="<%=path %>/static/img/icon/jushoucang.png.png" style="width:20px;height:20px;"></span>
